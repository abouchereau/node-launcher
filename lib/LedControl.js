    ...
    startTurnOnDemo() {
        if (this.leds != null) {
            this.intervalTurnOnDemo = setInterval(() => {
                this.leds.setColor('green', {"index": Utils.modulo(this.incremDemo,LedControl.NB_LEDS)});
                this.leds.setColor('black', {"index": Utils.modulo(this.incremDemo-1,LedControl.NB_LEDS)});
                this.incremDemo++;
            },100);
        }
    }
